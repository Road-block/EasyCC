...
{37538    , "Immune"},]]		-- Anti-Magic Shield
...
function EasyCC:PlayerAura(unit)
  ...
  if f.InterruptspellID and not disabled[f.InterruptspellID] then
    ...
    if f.InterruptspellID == 37359 then spellCategory = "Interrupt" end -- fix for Snap Kick
...
local teststring = {"Holy Locked", "Polymorph", "Shadow Locked", "Stunned", "Feared", "", "Long String to Test Red Bar", "Kick"}
